...
namespace OnlineShop.Controllers
{
    public class UserController : Controller
    {
        ...
        public JsonResult LoadPrecinct(int provinceID, int districtID)
        {
            var xmlDoc = XDocument.Load(Server.MapPath(@"/assets/client/data/Provinces_Data.xml"));
            var xElement = xmlDoc.Element("Root")
                .Elements("Item").Where(x => x.Attribute("type").Value == "province" && int.Parse(x.Attribute("id").Value) == provinceID)
                .Elements("Item").Where(x => x.Attribute("type").Value == "district" && int.Parse(x.Attribute("id").Value) == districtID);
